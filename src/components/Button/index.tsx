  ...
  if (theme === "filled")
    ...
    return (
      <button
        type={type}
        onClick={onClick}
        className="w-full px-8 py-1 leading-5 bg-white text-black border-black border-solid 3xl:text-lg laptop:text-sm hover:text-white hover:bg-black hover:border-transparent"
      >
        {children}
      </button>
    );
